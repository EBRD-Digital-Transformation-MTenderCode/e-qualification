...
import com.procurement.qualification.infrastructure.configuration.properties.CassandraProperties
...
@ComponentScan(
    basePackages = [
        "com.procurement.qualification.infrastructure.repository"
    ]
)
